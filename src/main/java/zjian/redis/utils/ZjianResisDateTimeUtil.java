...
public class ZjianResisDateTimeUtil {
  ...
  public static final String DEFAULT_DATETIME_FORMAT_ALL = "yyyyMMddHHmmssss";

  /**
   * 私有构造方法，禁止对该类进行实例化
   */
  private ZjianResisDateTimeUtil() {}
  ...
  public static String getDateTimeAll() {
	    return getDateTime(DEFAULT_DATETIME_FORMAT_ALL);
	  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("得到当前日期 － getDate():" + ZjianResisDateTimeUtil.getDate());
      System.out.println("得到当前日期时间 － getDateTime():" + ZjianResisDateTimeUtil.getDateTime());
      System.out.println("得到当前日期时间 － getDateTimeAll():" + ZjianResisDateTimeUtil.getDateTimeAll());
      System.out.println("得到当前年份 － getCurrentYear():" + ZjianResisDateTimeUtil.getCurrentYear());
      System.out.println("得到当前月份 － getCurrentMonth():" + ZjianResisDateTimeUtil.getCurrentMonth());
      System.out.println("得到当前日子 － getCurrentDay():" + ZjianResisDateTimeUtil.getCurrentDay());
      ...
      System.out.println("比较日期 － diffDays():" + ZjianResisDateTimeUtil.diffDays(ZjianResisDateTimeUtil.getNow(), date));
      System.out.println("比较月份 － diffMonths():" + ZjianResisDateTimeUtil.diffMonths(ZjianResisDateTimeUtil.getNow(), date));
