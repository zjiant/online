...
@Service("bZjianSpringRedisPoolString")
public class ZjianSpringRedisPoolString implements Serializable {
	...
	public void returnResourceShouldResetState() {
		GenericObjectPoolConfig config = bZjianSpringJedisSentinelPoolConfig.getJedisPoolConfig();
		JedisSentinelPool pool = new JedisSentinelPool(Constants.MASTER_NAME,
				bZjianSpringJedisSentinelPool.sentinels, config, 1000,
